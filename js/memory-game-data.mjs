...
export const memoryGamePairs = [
  ...
  { id: "network-tcp", name: "TCP", category: "networks", visual: symbol("tcp"), definition: "Entrega dados com confirmação, controle de ordem e retransmissão quando necessário.", alt: "Pacotes numerados com confirmação de recebimento" },
  { id: "network-udp", name: "UDP", category: "networks", visual: symbol("udp"), definition: "Envia dados com pouca sobrecarga, sem confirmar cada entrega ou reorganizar os pacotes.", alt: "Pacotes rápidos enviados sem confirmação" },
